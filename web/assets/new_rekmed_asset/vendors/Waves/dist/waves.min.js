  ...
  function j(a) {
    ...
    if (null !== b) {
      ...
      if ((q.registerEvent(a), "touchstart" === a.type && o.delay)) {
        ...
        o.show(a, b),
          n &&
            (b.addEventListener("touchend", o.hide, !1),
  ...
  var k = k || {},
    ...
    o = {
      ...
      show: function (a, b, c) {
        ...
        "touches" in a && a.touches.length
          ? ((h = a.touches[0].pageY - e.top),
            (i = a.touches[0].pageX - e.left))
          : ((h = a.pageY - e.top), (i = a.pageX - e.left)),
          (i = i >= 0 ? i : 0),
          (h = h >= 0 ? h : 0);
    ...
    q = {
      ...
      allowEvent: function (a) {
        var b = !0;
        return (
          /^(mousedown|mousemove)$/.test(a.type) && q.touches && (b = !1), b
        );
      },
  ...
  return (
    (k.init = function (a) {
      ...
      (a = a || {}),
        ...
        n &&
          (b.addEventListener("touchstart", j, !1),
    ...
    (k.attach = function (a, b) {
      ...
      for (var c, d, f = 0, g = a.length; g > f; f++)
        (c = a[f]),
          ...
          -1 !== ["input", "img"].indexOf(d) &&
            (p[d](c), (c = c.parentElement)),
    ...
    (k.ripple = function (a, b) {
      ...
      if (
        ...
        for (
          ...
          if (
            ((d = a[j]),
            (g = b.position || { x: d.clientWidth / 2, y: d.clientHeight / 2 }),
            (h = f(d)),
            (i.x = h.left + g.x),
            (i.y = h.top + g.y),
            (k.pageX = i.x),
