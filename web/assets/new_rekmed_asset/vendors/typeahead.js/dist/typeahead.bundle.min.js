      ...
      h = (function () {
        ...
        function c(c, e) {
          (c = c || {}),
            ...
            c.name &&
              !h(c.name) &&
              a.error("invalid datassets name: " + c.name),
            e.mixin(this),
            ...
            (this.$el = a(c.node)
              .addClass(this.classes.datassets)
              .addClass(this.classes.datassets + "-" + this.name));
        }
        function d(a) {
          function c(b) {
            return b[a];
        ...
        return (
          ...
          b.mixin(c.prototype, e, {
            ...
            _renderPending: function (a) {
              ...
              this._resetLastSuggestion(),
                b && this.$el.html(b({ query: a, datassets: this.name }));
            },
      ...
      i = (function () {
        ...
        function c(c, d) {
          ...
          (c = c || {}),
            ...
            (this.$node = a(c.node)),
            (this.query = null),
            (this.datassetss = b.map(c.datassetss, e));
        }
        return (
          b.mixin(c.prototype, e, {
            ...
            _onRendered: function (a, b, c, d) {
              this.$node.toggleClass(
                this.classes.empty,
                this._allDatassetssEmpty()
              ),
                this.trigger("datassetsRendered", b, c, d);
            },
            _onCleared: function () {
              this.$node.toggleClass(
                this.classes.empty,
                ...
                this.trigger("datassetsCleared");
            },
            _propagate: function () {
              this.trigger.apply(this, arguments);
            },
            _allDatassetssEmpty: function () {
              function a(a) {
                return a.isEmpty();
              }
              return b.every(this.datassetss, a);
            },
            ...
            bind: function () {
              ...
              return (
                ...
                b.each(this.datassetss, function (a) {
            ...
            update: function (a) {
              ...
              var d = a !== this.query;
              return d && ((this.query = a), b.each(this.datassetss, c)), d;
            },
            empty: function () {
              function a(a) {
                a.clear();
              }
              b.each(this.datassetss, a),
                (this.query = null),
      ...
      j = (function () {
        ...
        return (
          b.mixin(a.prototype, i.prototype, {
            open: function () {
              return (
                !this._allDatassetssEmpty() && this._show(),
      ...
      k = (function () {
        ...
        function c(c, e) {
          ...
          (c = c || {}),
            ...
            this.menu
              ...
              .onSync("datassetsRendered", this._onDatassetsRendered, this)
              .onSync("datassetsCleared", this._onDatassetsCleared, this),
        ...
        return (
          b.mixin(c.prototype, {
            ...
            _onDatassetsCleared: function () {
              this._updateHint();
            },
            _onDatassetsRendered: function (a, b, c, d) {
