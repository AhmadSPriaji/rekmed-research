  ...
  !(function (t) {
    ...
    var t,
      ...
      R = function () {
        ...
        function n(e) {
          if (
            ...
            !c &&
            !O(e)[2] &&
            (e.stopImmediatePropagation(), (!C || b) && d)
          ) {
            g = G();
            var t = M.offset(),
              o = O(e)[0] - t.top,
      ...
      j = function (t) {
        ...
        return t
          ? (clearTimeout(f[0].autoUpdate), void K(f[0], "autoUpdate"))
          : void o();
      },
      X = function (e, t, o) {
      ...
      V = function (t, o, n) {
        ...
        function r() {
          return [
            ...
            c.callbacks.alwaysTriggerOffsets || -y >= _,
          ];
        }
        function l() {
        ...
        if (
          ...
          S[1] < 0 || (0 === S[0] && 0 === S[1])
            ...
            (s.tweenRunning ||
              ...
              (Q(v[0], x, Math.round(S[1]), u[1], n.scrollEasing),
