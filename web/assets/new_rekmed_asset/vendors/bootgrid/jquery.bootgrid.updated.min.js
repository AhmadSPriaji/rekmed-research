!(function (t, e) {
  ...
  function n() {
    var e = {
      ...
      i = this.options.post;
    return (
      (i = t.isFunction(i) ? i() : i),
      this.options.requestHandler(t.extend(!0, e, i))
    );
  }
  function r(e) {
  ...
  function a() {
    this.element.trigger("initialize" + j),
      d.call(this),
      ...
      v.call(this),
      u.call(this),
      this.element.trigger("initialized" + j);
  }
  function c() {
    ...
    i.children().each(function () {
      var i = t(this),
        ...
        n = {
          ...
          converter:
            e.options.converters[o.converter || o.type] ||
            e.options.converters.string,
          text: i.text(),
          align: o.align || "left",
      ...
      e.columns.push(n),
        null != n.order && (e.sortDictionary[n.id] = n.order),
        n.identifier && ((e.identifier = n.id), (e.converter = n.converter)),
        e.options.multiSort || null === n.order || (s = !0);
    });
  }
  function u() {
    function i(t) {
      for (
        var e,
          i = new RegExp(o.searchPhrase, o.options.caseSensitive ? "g" : "gi"),
          s = 0;
        s < o.columns.length;
        s++
      )
        if (
          ((e = o.columns[s]),
          e.searchable && e.visible && e.converter.to(t[e.id]).search(i) > -1)
        )
          return !0;
      return !1;
    }
    function s(t, e) {
      (o.currentRows = t),
        f.call(o, e),
        o.options.keepSelection || (o.selectedRows = []),
        D.call(o, t),
        b.call(o),
        y.call(o),
        o.element._bgBusyAria(!1).trigger("loaded" + j);
    }
    var o = this;
    if (
      (this.element._bgBusyAria(!0).trigger("load" + j),
      P.call(this),
      this.options.ajax)
    ) {
      var r = n.call(this),
      ...
      if (null == a || "string" != typeof a || 0 === a.length)
        throw new Error(
          "Url setting must be a none empty string or a function that returns one."
        );
      ...
      var c = {
        ...
        error: function (t, e) {
          (o.xqr = null),
            "abort" !== e &&
              (w.call(o), o.element._bgBusyAria(!1).trigger("loaded" + j));
        },
      };
      ...
      var h = this.searchPhrase.length > 0 ? this.rows.where(i) : this.rows,
        d = h.length;
      -1 !== this.rowCount && (h = h.page(this.current, this.rowCount)),
  ...
  function f(t) {
    (this.total = t),
      (this.totalPages =
        -1 === this.rowCount ? 1 : Math.ceil(this.total / this.rowCount));
  }
  function g() {
    var e = this.options.templates,
      i = this.element.parent().hasClass(this.options.css.responsiveTable)
        ? this.element.parent()
        : this.element;
    this.element.addClass(this.options.css.table),
      0 === this.element.children("tbody").length &&
        this.element.append(e.body),
      1 & this.options.navigation &&
        ((this.header = t(
          e.header.resolve(
            o.call(this, { id: this.element._bgId() + "-header" })
          )
        )),
        i.before(this.header)),
      2 & this.options.navigation &&
        ((this.footer = t(
          e.footer.resolve(
            o.call(this, { id: this.element._bgId() + "-footer" })
          )
        )),
        i.after(this.footer));
  }
      ...
      if (n.length > 0) {
        ...
        if (this.options.ajax) {
          var h = a.icon.resolve(o.call(this, { iconCss: e.iconRefresh })),
            d = t(
              a.actionButton.resolve(
                o.call(this, { content: h, text: this.options.labels.refresh })
              )
    ...
    if (this.options.columnSelection && this.columns.length > 1) {
      ...
      t.each(this.columns, function (e, l) {
        if (l.visibleInSelection) {
          var f = t(
            n.actionDropDownCheckboxItem.resolve(
              o.call(i, { name: l.id, label: l.text, checked: l.visible })
            )
            ...
            if (!o.prop("disabled")) {
              ...
              s
                .parents(p)
                .find(c + ":has(" + d + ":checked)")
                ._bgEnableAria(n)
                .find(d)
                ._bgEnableField(n),
                i.element.find("tbody").empty(),
                R.call(i),
                u.call(i);
            }
          });
    ...
    if (0 !== this.options.navigation) {
      ...
      if (i.length > 0) {
        var n = this.current * this.rowCount,
          l = t(
            this.options.templates.infos.resolve(
              o.call(this, {
                end:
                  0 === this.total || -1 === n || n > this.total
                    ? this.total
                    : n,
  ...
  function w() {
    ...
    this.selection && (i += 1),
      t.html(e.noResults.resolve(o.call(this, { columns: i })));
  }
  function y() {
    if (0 !== this.options.navigation) {
      ...
      if (-1 !== this.rowCount && i.length > 0) {
        var n = this.options.templates,
          ...
          u =
            h >= this.options.padding
              ? Math.max(d, 1)
              : Math.max(d - this.options.padding + h, 1),
        ...
        for (var g = 0; f > g; g++) {
          var v = g + u;
          x.call(this, c, v, v, "page-" + v)
            ._bgEnableAria()
            ._bgSelectAria(v === l);
        }
        0 === f &&
          x.call(this, c, 1, 1, "page-1")._bgEnableAria(!1)._bgSelectAria(),
          x
            .call(
              this,
              c,
  ...
  function x(e, i, s, n) {
    var l = this,
      ...
      d = t(a.paginationItem.resolve(h)).on(
        "click" + j,
        r(c.paginationButton),
        function (e) {
  ...
  function C(e) {
    ...
    if (t.isArray(n)) {
      var l = this.options.css,
        a = this.options.templates,
        c = t(
          a.actionDropDown.resolve(o.call(this, { content: i(this.rowCount) }))
        ),
        h = r(l.dropDownMenu),
      ...
      t.each(n, function (e, n) {
        var r = t(
          a.actionDropDownItem.resolve(o.call(s, { text: i(n), action: n }))
        )
          ._bgSelectAria(n === s.rowCount)
          .on("click" + j, f, function (e) {
            e.preventDefault();
            var o = t(this),
              n = o.data("action");
            n !== s.rowCount &&
    ...
    if (e.length > 0) {
      ...
      t.each(e, function (e, r) {
        var l = "",
          h =
            ' data-row-id="' +
            (null == i.identifier ? e : r[i.identifier]) +
            '"',
          d = "";
        if (i.selection) {
          ...
          (l += n.cell.resolve(o.call(i, { content: p, css: s.selectCell }))),
            (a = a && u),
            u && ((d += s.selected), (h += ' aria-selected="true"'));
        }
        var f = null != r.status && i.options.statusMapping[r.status];
        f && (d += f),
          t.each(i.columns, function (e, a) {
            if (a.visible) {
              var c = t.isFunction(a.formatter)
                  ? a.formatter.call(i, a, r)
                  : a.converter.to(r[a.id]),
          ...
          d.length > 0 && (h += ' class="' + d + '"'),
          (c += n.row.resolve(o.call(i, { attr: h, cells: l })));
      }),
        i.element
          .find("thead " + r(i.options.css.selectBox))
          .prop("checked", a),
        l.html(c),
        A.call(this, l);
    } else w.call(this);
  ...
  function A(e) {
    ...
    this.selection &&
      e.off("click" + j, s).on("click" + j, s, function (e) {
        e.stopPropagation();
        var s = t(this),
      ...
      e.off("click" + j, "> tr").on("click" + j, "> tr", function (e) {
        ...
        var s = t(this),
          o =
            null == i.identifier
              ? s.data("row-id")
              : i.converter.from(s.data("row-id") + ""),
          n =
            null == i.identifier
              ? i.currentRows[o]
              : i.currentRows.first(function (t) {
                  return t[i.identifier] === o;
                });
        i.selection &&
          i.options.rowSelect &&
          (s.hasClass(i.options.css.selected)
            ? i.deselect([o])
            : i.select([o])),
          i.element.trigger("click" + j, [i.columns, n]);
      });
  }
  function k() {
    if (0 !== this.options.navigation) {
      ...
      if (l.length > 0) {
        ...
        f.on("keyup" + j, function (i) {
          ...
          (d !== s || (13 === i.which && "" !== s)) &&
            ...
            (13 === i.which ||
              0 === s.length ||
              s.length >= a.options.searchSettings.characters) &&
              (e.clearTimeout(h),
  ...
  function S(t) {
    this.searchPhrase !== t &&
      ((this.current = 1), (this.searchPhrase = t), u.call(this));
  }
  function R() {
    var e = this,
    ...
    if (this.selection) {
      var c = this.options.multiSelect
        ? n.select.resolve(o.call(e, { type: "checkbox", value: "all" }))
        : "";
      l += n.rawHeaderCell.resolve(
        o.call(e, { content: c, css: s.selectCell })
      );
    }
    if (
      (t.each(this.columns, function (t, i) {
        if (i.visible) {
          ...
          l += n.headerCell.resolve(
            o.call(e, {
              column: i,
              icon: h,
              sortable: (a && i.sortable && s.sortable) || "",
              css:
                ("right" === d ? s.right : "center" === d ? s.center : s.left) +
                u,
    ...
    if (this.selection && this.options.multiSelect) {
      ...
      i.off("click" + j, d).on("click" + j, d, function (i) {
        i.stopPropagation(),
          t(this).prop("checked") ? e.select() : e.deselect();
      });
    }
  }
  function _(t) {
    ...
    if (
      (this.options.multiSort ||
        (t
          ...
          .first()
          .find(i)
          .removeClass(e.iconDown + " " + e.iconUp),
        (this.sortDictionary = {})),
      o && "asc" === o)
    )
      (this.sortDictionary[s] = "desc"),
        n.removeClass(e.iconUp).addClass(e.iconDown);
    else if (o && "desc" === o)
      if (this.options.multiSort) {
        var l = {};
        for (var a in this.sortDictionary)
          a !== s && (l[a] = this.sortDictionary[a]);
        (this.sortDictionary = l), n.removeClass(e.iconDown);
      } else
        (this.sortDictionary[s] = "asc"),
          n.removeClass(e.iconDown).addClass(e.iconUp);
  ...
  function P() {
    ...
    e.setTimeout(function () {
      if ("true" === t.element._bgAria("busy")) {
        ...
        t.selection && (l += 1),
          s.html(e.loading.resolve(o.call(t, { columns: l }))),
          -1 !== t.rowCount &&
            r > 0 &&
            s.find("tr > td").css("padding", "20px 0 " + r + "px");
      }
    }, 250);
  }
  function B() {
    ...
    var e = [];
    if (!this.options.ajax) {
      for (var i in this.sortDictionary)
        (this.options.multiSort || 0 === e.length) &&
          e.push({ id: i, order: this.sortDictionary[i] });
  ...
  var j = ".rs.jquery.bootgrid",
    M = function (e, i) {
      (this.element = t(e)),
        ...
        (this.options = t.extend(!0, {}, M.defaults, this.element.data(), i));
      var s = (this.options.rowCount =
        this.element.data().rowCount || i.rowCount || this.options.rowCount);
      (this.columns = []),
        (this.current = 1),
        (this.currentRows = []),
        ...
        (this.selection = !1),
        (this.converter = null),
        (this.rowCount = t.isArray(s) ? s[0] : s),
        (this.rows = []),
        (this.searchPhrase = ""),
        (this.selectedRows = []),
        (this.sortDictionary = {}),
  ...
  if (
    ((M.defaults = {
      ...
      templates: {
        ...
        actionDropDown:
          '<div class="{{css.dropDownMenu}}"><button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown"><span class="{{css.dropDownMenuText}}">{{ctx.content}}</span> <span class="caret"></span></button><ul class="{{css.dropDownMenuItems}}" role="menu"></ul></div>',
        actionDropDownItem:
          '<li><a data-action="{{ctx.action}}" class="{{css.dropDownItem}} {{css.dropDownItemButton}}">{{ctx.text}}</a></li>',
        actionDropDownCheckboxItem:
          '<li><div class="checkbox"><label class="{{css.dropDownItem}}"><input name="{{ctx.name}}" type="checkbox" value="1" class="{{css.dropDownItemCheckbox}}" {{ctx.checked}} /> {{ctx.label}}<i class="input-helper"></i></label></div></li>',
        ...
        header:
          '<div id="{{ctx.id}}" class="{{css.header}}"><div class="row"><div class="col-sm-12 actionBar"><p class="{{css.search}}"></p><p class="{{css.actions}}"></p></div></div></div>',
        headerCell:
          '<th data-column-id="{{ctx.column.id}}" class="{{ctx.css}}" style="{{ctx.style}}"><a href="javascript:void(0);" class="{{css.columnHeaderAnchor}} {{ctx.sortable}}"><span class="{{css.columnHeaderText}}">{{ctx.column.text}}</span>{{ctx.icon}}</a></th>',
        icon: '<span class="{{css.icon}} {{ctx.iconCss}}"></span>',
        infos: '<div class="{{css.infos}}">{{lbl.infos}}</div>',
        loading:
          '<tr><td colspan="{{ctx.columns}}" class="loading">{{lbl.loading}}</td></tr>',
        noResults:
          '<tr><td colspan="{{ctx.columns}}" class="no-results">{{lbl.noResults}}</td></tr>',
        pagination: '<ul class="{{css.pagination}}"></ul>',
        paginationItem:
          '<li class="{{ctx.css}}"><a data-page="{{ctx.page}}" class="{{css.paginationButton}}">{{ctx.text}}</a></li>',
        rawHeaderCell: '<th class="{{ctx.css}}">{{ctx.content}}</th>',
        row: "<tr{{ctx.attr}}>{{ctx.cells}}</tr>",
        search:
          '<div class="{{css.search}}"><div class="input-group"><span class="{{css.icon}} input-group-addon {{css.iconSearch}}"></span> <input type="text" class="{{css.searchField}}" placeholder="{{lbl.search}}" /></div></div>',
        select:
          '<div class="checkbox"><label><input name="select" type="{{ctx.type}}" class="{{css.selectBox}}" value="{{ctx.value}}" {{ctx.checked}} /><i class="input-helper"></i></label></div>',
      },
    }),
    (M.prototype.append = function (t) {
      if (this.options.ajax);
        ...
        for (var e = [], s = 0; s < t.length; s++)
          i.call(this, t[s]) && e.push(t[s]);
        B.call(this),
          c.call(this, e),
          u.call(this),
          this.element.trigger("appended" + j, [e]);
      }
      return this;
    }),
    (M.prototype.clear = function () {
      if (this.options.ajax);
        ...
        (this.rows = []),
          ...
          (this.total = 0),
          u.call(this),
          this.element.trigger("cleared" + j, [e]);
      }
      return this;
    }),
    ...
    (M.prototype.remove = function (t) {
      if (null != this.identifier) {
        if (this.options.ajax);
          ...
          (this.current = 1),
            u.call(this),
            this.element.trigger("removed" + j, [i]);
        }
      }
      return this;
    }),
    ...
    (M.prototype.select = function (e) {
      if (this.selection) {
        ...
        for (
          var i, s, o = [];
          e.length > 0 && (this.options.multiSelect || 1 !== o.length);
        ...
        if (o.length > 0) {
          ...
          for (
            s = 0;
            !this.options.keepSelection && l && s < this.currentRows.length;

          )
            l =
              -1 !==
              t.inArray(
                this.currentRows[s++][this.identifier],
                this.selectedRows
              );
          for (
            this.element.find("thead " + n).prop("checked", l),
              this.options.multiSelect ||
                this.element
                  .find("tbody > tr " + n + ":checked")
                  .trigger("click" + j),
              s = 0;
            s < this.selectedRows.length;
            s++
          )
            this.element
              .find('tbody > tr[data-row-id="' + this.selectedRows[s] + '"]')
    ...
    (M.prototype.deselect = function (e) {
      if (this.selection) {
        ...
        if (n.length > 0) {
          ...
          for (
            this.element.find("thead " + l).prop("checked", !1), s = 0;
            s < n.length;
            s++
          )
            this.element
              .find('tbody > tr[data-row-id="' + n[s][this.identifier] + '"]')
    ...
    (M.prototype.sort = function (e) {
      var i = e ? t.extend({}, e) : {};
      return i === this.sortDictionary
        ? this
        : ((this.sortDictionary = i),
          R.call(this),
          B.call(this),
          u.call(this),
          this);
        ...
        t.each(e, function (e, o) {
          if (null != o && "function" != typeof o)
            if ("object" == typeof o) {
              ...
              T && T[e] && "function" == typeof T[e] && (o = T[e](o)),
                (e = i ? i.join(".") + "." + e : e);
  ...
  Array.prototype.first ||
    ...
    Array.prototype.page ||
      (Array.prototype.page = function (t, e) {
        var i = (t - 1) * e,
          s = i + e;
    ...
    Array.prototype.propValues ||
      (Array.prototype.propValues = function (t) {
  ...
  (t.fn.bootgrid = function (e) {
    var i = Array.prototype.slice.call(arguments, 1),
      ...
      o = this.each(function (o) {
        ...
        if (
          (r || "destroy" !== e) &&
          (r || (n.data(j, (r = new M(this, l))), a.call(r)),
          "string" == typeof e)
        )
    ...
    (t.fn.bootgrid.Constructor = M),
    (t.fn.bootgrid.noConflict = function () {
