!(function (e) {
  ...
  Array.prototype.reduce ||
    ...
    Array.prototype.map ||
      (Array.prototype.map = function (e, t) {
        ...
        for (
          arguments.length > 1 && (n = t), o = new Array(a), i = 0;
          a > i;
  ...
  if (r) {
    ...
    a && (t = parseFloat(a[1])),
      (a = /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(i)),
      a && (t = parseFloat(a[1]));
  }
  var s,
    l = {
    ...
    c = (function () {
      var t = function (e) {
        ...
        a = function (e, t) {
          for (var n = 0, o = e.length; o > n; n++) if (!t(e[n])) return !1;
          return !0;
        },
        s = function (t, n) {
    ...
    h = (function () {
      var t = function (t) {
        ...
        i = function (t) {
          ...
          var i;
          return (
            (i = n.is(".note-editor, .note-air-editor")
              ? n
              : e("#note-editor-" + c.last(n.attr("id").split("-")))),
            o(i)
          );
        },
        r = function (e) {
        ...
        s = function (e) {
          return (
            e && /^BR|^IMG|^HR|^IFRAME|^BUTTON/.test(e.nodeName.toUpperCase())
          );
        },
        p = function (e) {
          return t(e)
            ? !1
            : e && /^DIV|^P|^LI|^H[1-7]/.test(e.nodeName.toUpperCase());
        },
        v = r("LI"),
        g = function (e) {
          return p(e) && !v(e);
        ...
        M = function (e) {
          ...
          return 0 === t
            ? !0
            : a(e) || 1 !== t || e.innerHTML !== F
            ? c.all(e.childNodes, a) && "" === e.innerHTML
              ? !0
              : !1
            : !0;
        },
        ...
        j = function (e, t) {
          ...
          return (
            ...
            (function o(i) {
              e !== i && t(i) && n.push(i);
              for (var r = 0, a = i.childNodes.length; a > r; r++)
                o(i.childNodes[r]);
            })(e),
            n
          );
        ...
        et = function (e, n) {
          ...
          if (0 === e.offset) {
            ...
            $(e.node)
              ? ((o = e.node.childNodes[e.offset - 1]), (i = I(o)))
              : ((o = e.node), (i = n ? 0 : e.offset - 1));
        ...
        tt = function (e, n) {
          ...
          if (I(e.node) === e.offset) {
            ...
            $(e.node)
              ? ((o = e.node.childNodes[e.offset]), (i = 0))
              : ((o = e.node), (i = n ? I(e.node) : e.offset + 1));
          return { node: o, offset: i };
        },
        nt = function (e, t) {
        ...
        dt = function (e, t) {
          for (var n = e, o = 0, i = t.length; i > o; o++)
            n =
          ...
          return o.length
            ? 1 === o.length
              ...
              : o.reduce(function (e, o) {
                  return (
                    e === t.node && (e = ct(t, n)),
                    ct({ node: o, offset: e ? h.position(e) : I(o) }, n)
                  );
                })
            : null;
        },
        ft = function (e, t) {
          ...
          var s =
            n &&
            ut(n, e, { isSkipPaddingBlankHTML: t, isNotSplitEdgePoint: t });
          return (
          ...
          if (e && e.parentNode) {
            ...
            if (!t) {
              var o,
                i,
                r = [];
              for (o = 0, i = e.childNodes.length; i > o; o++)
      ...
      var t = function (e, t) {
        ...
        o = function (t, i, r, a) {
          ...
          var s = function () {
            ...
            var o = n({ node: t, offset: i });
            return o.setEndPoint("EndToEnd", n({ node: r, offset: a })), o;
          };
          (this.getPoints = function () {
            return { sc: t, so: i, ec: r, eo: a };
          }),
            (this.getStartPoint = function () {
              return { node: t, offset: i };
            }),
            (this.getEndPoint = function () {
              return { node: r, offset: a };
            }),
            ...
            (this.normalize = function () {
              var e = function (e, t) {
                  if (
                    (h.isVisiblePoint(e) && !h.isEdgePoint(e)) ||
                    (h.isVisiblePoint(e) && h.isRightEdgePoint(e) && !t) ||
                    (h.isVisiblePoint(e) && h.isLeftEdgePoint(e) && t) ||
                    (h.isVisiblePoint(e) &&
                      h.isBlock(e.node) &&
                      h.isEmpty(e.node))
                  )
                  ...
                  if (
                    ((h.isLeftEdgePointOf(e, n) ||
                      h.isVoid(h.prevPoint(e).node)) &&
                      !t) ||
                    ((h.isRightEdgePointOf(e, n) ||
                      h.isVoid(h.nextPoint(e).node)) &&
                      t)
                  ) {
                  ...
                  var o = t
                    ? h.nextPointUntil(h.nextPoint(e), h.isVisiblePoint)
                    : h.prevPointUntil(h.prevPoint(e), h.isVisiblePoint);
                  return o || e;
                },
                ...
                h.walkPoint(
                  ...
                  function (t) {
                    if (!h.isEditable(t.node)) {
                      var i;
                      o
                        ? (h.isLeftEdgePoint(t) && s.push(t.node),
                          h.isRightEdgePoint(t) &&
                            c.contains(s, t.node) &&
                            (i = t.node))
                        : (i = n ? h.ancestor(t.node, e) : t.node),
                        i && e(i) && a.push(i);
                    }
                  },
                  !0
            ...
            (this.expand = function (e) {
              ...
              return (
                n && ((l.sc = n), (l.so = 0)),
                s && ((l.ec = s), (l.eo = h.nodeLength(s))),
                new o(l.sc, l.so, l.ec, l.eo)
              );
            }),
            ...
            (this.splitText = function () {
              ...
              return (
                h.isText(r) &&
                  !h.isEdgePoint(this.getEndPoint()) &&
                  r.splitText(a),
                h.isText(t) &&
                  !h.isEdgePoint(this.getStartPoint()) &&
                  ((n.sc = t.splitText(i)),
                  (n.so = 0),
                  e && ((n.ec = n.sc), (n.eo = a - i))),
                new o(n.sc, n.so, n.ec, n.eo)
              );
            }),
            (this.deleteContents = function () {
              ...
              return (
                e.each(n, function (e, t) {
                  var n = t.parentNode;
                  i.node !== n && 1 === h.nodeLength(n) && r.push(n),
                    h.remove(t, !1);
                }),
          ...
          (this.isOnEditable = u(h.isEditable)),
            (this.isOnList = u(h.isList)),
            (this.isOnAnchor = u(h.isAnchor)),
            (this.isOnCell = u(h.isCell)),
            ...
            (this.wrapBodyInlineWithPara = function () {
              if (h.isBodyContainer(t) && h.isEmpty(t))
                return (
                  ...
                  new o(t.firstChild, 0, t.firstChild, 0)
                );
              ...
              if (
                ((r = r.concat(h.listNext(n.nextSibling, h.isParaInline))),
                r.length)
              ) {
            ...
            (this.bookmark = function (e) {
              return {
                s: { path: h.makeOffsetPath(e, t), offset: i },
                e: { path: h.makeOffsetPath(e, r), offset: a },
              };
            }),
            (this.paraBookmark = function (e) {
              return {
                s: { path: c.tail(h.makeOffsetPath(c.head(e), t)), offset: i },
                e: { path: c.tail(h.makeOffsetPath(c.last(e), r)), offset: a },
              };
            }),
      ...
      return {
        create: function (e, n, i, r) {
          if (arguments.length) 2 === arguments.length && ((i = e), (r = n));
            ...
            h.isText(f.node) &&
              h.isLeftEdgePoint(f) &&
              h.isTextNode(p.node) &&
              h.isRightEdgePoint(p) &&
              p.node.nextSibling === f.node &&
              (f = p),
              (e = f.cont),
              (n = f.offset),
              (i = p.cont),
        ...
        createFromNode: function (e) {
          var t = e,
            ...
            i = h.nodeLength(o);
          return (
            h.isVoid(t) && ((n = h.listPrev(t).length - 1), (t = t.parentNode)),
            h.isBR(o)
              ? ((i = h.listPrev(o).length - 1), (o = o.parentNode))
              : h.isVoid(o) && ((i = h.listPrev(o).length), (o = o.parentNode)),
            this.create(t, n, o, i)
          );
        },
          ...
          return e
            .Deferred(function (o) {
              ...
              i.one("load", function () {
                ...
                .css({ display: "none" })
                .appendTo(document.body)
                .attr({ src: t, "data-filename": n });
            })
            .promise();
        };
      return { readFileAsDataURL: t, createImage: n };
    })(),
    m = (function () {
      var e = {
        BACKSPACE: 8,
    ...
    b = function (e) {
      var t = [],
        ...
        i = function () {
          var t = p.create(),
            n = { s: { path: [], offset: 0 }, e: { path: [], offset: 0 } };
          return { contents: e.html(), bookmark: t ? t.bookmark(o) : n };
        },
        r = function (t) {
          null !== t.contents && e.html(t.contents),
            null !== t.bookmark && p.createFromBookmark(o, t.bookmark).select();
        };
      (this.undo = function () {
        e.html() !== t[n].contents && this.recordUndo(),
          n > 0 && (n--, r(t[n]));
      }),
        (this.redo = function () {
    ...
    y = function () {
      ...
      (this.fromNode = function (e) {
        ...
        (this.stylePara = function (t, n) {
          e.each(t.nodes(h.isPara, { includeAncestor: !0 }), function (t, o) {
            e(o).css(n);
          });
        }),
        (this.styleNodes = function (t, n) {
          ...
          var a = h.makePredByNodeName(o),
            s = t.nodes(h.isText, { fullyContains: !0 }).map(function (e) {
        ...
        (this.current = function (t) {
          var n = e(h.isText(t.sc) ? t.sc.parentNode : t.sc),
            o = this.fromNode(n);
          if (
            ((o["font-bold"] = document.queryCommandState("bold")
              ? "bold"
              : "normal"),
            (o["font-italic"] = document.queryCommandState("italic")
              ? "italic"
              : "normal"),
            (o["font-underline"] = document.queryCommandState("underline")
              ? "underline"
              : "normal"),
            (o["font-strikethrough"] = document.queryCommandState(
              "strikeThrough"
            )
              ? "strikethrough"
              : "normal"),
            (o["font-superscript"] = document.queryCommandState("superscript")
              ? "superscript"
              : "normal"),
            (o["font-subscript"] = document.queryCommandState("subscript")
              ? "subscript"
              : "normal"),
            t.isOnList())
          ) {
          ...
          if (a && a.style["line-height"])
            o["line-height"] = a.style.lineHeight;
          else {
            var s =
          ...
          return (
            (o.anchor = t.isOnAnchor() && h.ancestor(t.sc, h.isAnchor)),
            (o.ancestors = h.listAncestor(t.sc, h.isEditable)),
            (o.range = t),
            o
          );
        });
      ...
      (this.insertOrderedList = function () {
        ...
        (this.indent = function () {
          var t = this,
            ...
            o = n.nodes(h.isPara, { includeAncestor: !0 }),
            i = c.clusterBy(o, d.peq2("parentNode"));
          e.each(i, function (n, o) {
            var i = c.head(o);
            h.isLi(i)
              ? t.wrapList(o, i.parentNode.nodeName)
        ...
        (this.toggleList = function (t) {
          var n = this,
            ...
            i = o.nodes(h.isPara, { includeAncestor: !0 }),
            r = o.paraBookmark(i),
          ...
          if (c.find(i, h.isPurePara)) {
            ...
            var l = o
              .nodes(h.isList, { includeAncestor: !0 })
              .filter(function (n) {
        ...
        (this.wrapList = function (e, t) {
          ...
          return (
            ...
            h.appendChildNodes(a, e),
            r && (h.appendChildNodes(a, c.from(r.childNodes)), h.remove(r)),
            e
          );
        }),
              ...
              var r = c.head(i),
                ...
                l =
                  s.childNodes.length > 1
                    ? h.splitTree(
                        s,
                        { node: a.parentNode, offset: h.position(a) + 1 },
                        { isSkipPaddingBlankHTML: !0 }
                      )
                    : null,
                d = h.splitTree(
                  s,
                  { node: r.parentNode, offset: h.position(r) },
                  { isSkipPaddingBlankHTML: !0 }
                );
              (i = n
                ? h.listDescendant(d, h.isLi)
                : c.from(d.childNodes).filter(h.isLi)),
                (n || !h.isList(s.parentNode)) &&
                  (i = i.map(function (e) {
    ...
    k = function () {
      ...
      (this.insertTab = function (e, t, n) {
        ...
        (this.insertParagraph = function () {
          ...
          var o,
            i = h.ancestor(n.sc, h.isPara);
          if (i) {
            if (h.isEmpty(i) && h.isLi(i))
              return void t.toggleList(i.parentNode.nodeName);
            o = h.splitTree(i, n.getStartPoint());
            var r = h.listDescendant(i, h.isEmptyAnchor);
            (r = r.concat(h.listDescendant(o, h.isEmptyAnchor))),
              e.each(r, function (e, t) {
                h.remove(t);
              });
          } else {
            ...
            (o = e(h.emptyPara)[0]),
              a ? n.sc.insertBefore(o, a) : n.sc.appendChild(o);
          }
    ...
    x = function () {
      (this.tab = function (e, t) {
        ...
        (this.createTable = function (t, n) {
          for (var o, i = [], r = 0; t > r; r++)
            i.push("<td>" + h.blank + "</td>");
          o = i.join("");
          for (var a, s = [], l = 0; n > l; l++) s.push("<tr>" + o + "</tr>");
          return (
            (a = s.join("")),
            e('<table class="table table-bordered">' + a + "</table>")[0]
          );
        });
    },
    w = "bogus",
    N = function (t) {
      ...
      (this.createRange = function (e) {
        ...
        (this.saveRange = function (e, t) {
          this.focus(e),
            ...
            t && p.create().collapse().select();
        }),
        (this.saveNode = function (e) {
          for (var t = [], n = 0, o = e[0].childNodes.length; o > n; n++)
        ...
        (this.restoreNode = function (e) {
          e.html("");
          for (var t = e.data("childNodes"), n = 0, o = t.length; o > n; n++)
            e[0].appendChild(t[n]);
        }),
      ...
      for (
        var u = (this.beforeCommand = function (e) {
            s(e), n.focus(e);
          }),
      ...
      (this.tab = function (e, t) {
        ...
        n.isCollapsed() && n.isOnCell()
          ? i.tab(n)
          : (u(e), r.insertTab(e, n, t.tabsize), f(e));
      }),
        ...
        (this.insertImage = function (e, n, o) {
          g.createImage(n, o)
            .then(function (t) {
              u(e),
                t.css({ display: "", width: Math.min(e.width(), t.width()) }),
      ...
      (this.fontSize = function (t, n) {
        ...
        if (i.isCollapsed()) {
          var r = o.styleNodes(i),
            a = c.head(r);
          e(r).css({ "font-size": n + "px" }),
            a &&
              !h.nodeLength(a) &&
              ((a.innerHTML = h.ZERO_WIDTH_NBSP_CHAR),
              p.createFromNodeAfter(a.firstChild).select(),
              t.data(w, a));
        } else u(t), e(o.styleNodes(i)).css({ "font-size": n + "px" }), f(t);
      }),
        (this.insertHorizontalRule = function (t) {
          u(t);
          var n = p.create(),
            o = n.insertNode(e("<HR/>")[0]);
          o.nextSibling && p.create(o.nextSibling, 0).normalize().select(),
            f(t);
        }),
        (this.removeBogus = function (e) {
          ...
          if (t) {
            var n = c.find(c.from(t.childNodes), h.isText),
              o = n.nodeValue.indexOf(h.ZERO_WIDTH_NBSP_CHAR);
            -1 !== o && n.deleteData(o, 1),
              h.isEmpty(t) && h.remove(t),
              e.removeData(w);
          }
        }),
        (this.lineHeight = function (e, t) {
          u(e), o.stylePara(p.create(), { lineHeight: t }), f(e);
        }),
        ...
        (this.createLink = function (t, n, i) {
          ...
          (i = i || h.makeLayoutInfo(t).editor().data("options")),
            u(t),
            i.onCreateLink && (r = i.onCreateLink(r));
          var v = [];
          if (d) {
          ...
          e.each(v, function (t, n) {
            e(n).attr("href", r),
              s ? e(n).attr("target", "_blank") : e(n).removeAttr("target");
          });
        ...
        (this.color = function (e, t) {
          var n = JSON.parse(t),
            ...
            i = n.backColor;
          u(e),
            o && document.execCommand("foreColor", !1, o),
            i && document.execCommand("backColor", !1, i),
            f(e);
        }),
        ...
        (this.resize = function (e, t, n) {
          u(e), n.css({ width: 100 * t + "%", height: "" }), f(e);
        }),
        (this.resizeTo = function (e, t, n) {
          ...
          if (n) {
            var i = e.y / e.x,
              r = t.data("ratio");
            o = { width: r > i ? e.x : e.y / r, height: r > i ? e.x * r : e.y };
        ...
        (this.removeMedia = function (n, o, i) {
          u(n),
            i.detach(),
            t.bindCustomEvent(e(), n.data("callbacks"), "media.delete")(i, n),
            f(n);
        }),
        (this.focus = function (e) {
          e.focus(),
            l.isFF &&
              !p.create().isOnEditable() &&
    ...
    T = function () {
      (this.update = function (t, n) {
        ...
        if (n.image) {
          ...
          var s = r.attr("style");
          return (
            i('button[data-event="resize"][data-value="1"]', function () {
            ...
            void i(
              'button[data-event="resize"][data-value="0.25"]',
              function () {
        ...
        p.find(".note-current-fontsize").text(n["font-size"]),
          o(p, parseFloat(n["font-size"]));
        var v = t.find(".note-height");
        o(v, parseFloat(n["line-height"])),
    ...
    L = function () {
      ...
      var n = function (e) {
        ...
        t.on("mousemove", function (e) {
          var t = e.clientY - (o + P);
          (t = r.minHeight > 0 ? Math.max(t, r.minHeight) : t),
            (t = r.maxHeight > 0 ? Math.min(t, r.maxHeight) : t),
            n.height(t);
    ...
    E = function () {
      var t = new T(),
        n = function (t, n) {
          ...
          return { left: a.left, top: a.top + s };
        },
        o = function (e, t) {
          e.css({ display: "block", left: t.left, top: t.top });
        },
        i = 20;
      (this.update = function (r, a, s) {
        ...
        if (a.anchor) {
          ...
          u.attr("href", f).html(f),
            h ? u.attr("target", "_blank") : u.removeAttr("target"),
            o(l, n(a.anchor, { isAirMode: s }));
        } else l.hide();
        var p = r.find(".note-image-popover");
        a.image ? o(p, n(a.image, { isAirMode: s, isLeftTop: !0 })) : p.hide();
          ...
          if (h.isControlSizing(o.target)) {
            ...
            n
              .on("mousemove", function (e) {
                t.invoke(
                  "editor.resizeTo",
                  { x: e.clientX - u.left, y: e.clientY - (u.top - f) },
                  c,
                  !e.shiftKey
                ),
                  t.invoke("handle.update", r, { image: d }, p),
                  t.invoke("popover.update", a, { image: d }, p);
              })
              .one("mouseup", function () {
      ...
      (this.attach = function (e) {
        ...
        (this.update = function (t, n, o) {
          ...
          if (n.image) {
            var r = e(n.image),
              a = o ? r.offset() : r.position(),
              s = { w: r.outerWidth(!0), h: r.outerHeight(!0) };
            i.css({
              display: "block",
              left: a.left,
              top: a.top,
      ...
      this.toggle = function (e) {
        var i = e.editor(),
          ...
          l = function (e) {
            a.css("height", e.h),
              s.css("height", e.h),
              s.data("cmeditor") && s.data("cmeditor").setsize(null, e.h);
          };
        i.toggleClass("fullscreen");
        var d = i.hasClass("fullscreen");
        d
          ? (a.data("orgheight", a.css("height")),
            n
              .on("resize", function () {
                l({ h: n.height() - r.outerHeight() });
              })
              .trigger("resize"),
            o.css("overflow", "hidden"))
          : (n.off("resize"),
            l({ h: a.data("orgheight") }),
            o.css("overflow", "visible")),
          t.invoke("toolbar.updateFullscreen", r, d);
      };
    };
  l.hasCodeMirror &&
    (l.isSupportAmd
  ...
  var M = function (e) {
      (this.sync = function (t) {
        ...
        (this.activate = function (t) {
          var n = t.editor(),
            ...
            c = n.data("options");
          if (
            (r.val(h.html(i, c.prettifyHtml)),
            r.height(i.height()),
            e.invoke("toolbar.updateCodeview", o, !0),
            e.invoke("popover.hide", a),
            e.invoke("handle.hide", d),
            n.addClass("codeview"),
            r.focus(),
            l.hasCodeMirror)
          ) {
            ...
            if (c.codemirror.tern) {
              ...
              (u.ternServer = f),
                u.on("cursorActivity", function (e) {
                  f.updateArgHints(e);
                });
            }
        ...
        (this.deactivate = function (t) {
          ...
          var c = h.value(a, s.prettifyHtml) || h.emptyPara,
            u = r.html() !== c;
          r.html(c),
            r.height(s.height ? a.height() : "auto"),
            o.removeClass("codeview"),
            u &&
              e.bindCustomEvent(n, r.data("callbacks"), "change")(r.html(), r),
            r.focus(),
            e.invoke("toolbar.updateCodeview", i, !1);
        });
    },
    R = function (t) {
      var n = e(document);
      (this.attach = function (e, t) {
        t.airMode || t.disableDragAndDrop
          ...
          n
            .on("dragenter", function (e) {
              ...
              n ||
                ...
                s.width(a.width()),
                s.height(a.height()),
                l.text(i.langInfo.image.dragImageHere)),
                (r = r.add(e.target));
            })
              ...
              .on("drop", function (n) {
                ...
                if (o && o.files && o.files.length)
                  ...
                  for (
                    ...
                    var l = o.types[a],
                      d = o.getData(l);
                    l.toLowerCase().indexOf("text") > -1
                      ? i.holder().summernote("pasteHTML", d)
                      : e(d).each(r);
                  }
              })
              .on("dragover", !1);
    ...
    A = function (t) {
      ...
      this.attach = function (r) {
        (l.isMSIE && l.browserVersion > 10) || l.isFF
          ? ((n = e("<div />")
      ...
      var o = function (o) {
          ...
          if (h.isImg(r)) {
            for (
              ...
              l[d] = s.charCodeAt(d);
            var c = new Blob([l], { type: "image/png" });
            (c.name = "clipboard.png"),
        ...
        i = function (e) {
          ...
          if (n && n.items && n.items.length) {
            ...
            "file" === r.kind &&
              -1 !== r.type.indexOf("image/") &&
              t.insertImages(o, [r.getAsFile()]),
      ...
      (this.showLinkDialog = function (t, i, r) {
          ...
          .Deferred(function (e) {
            ...
            t.one("shown.bs.modal", function () {
              a.val(r.text),
                ...
                r.url || ((r.url = r.text || "http://"), n(l, r.text)),
                s
                  .on("input", function () {
                ...
                o(s, l),
                o(a, l),
                d.prop("checked", r.isNewWindow),
                l.one("click", function (n) {
                  n.preventDefault(),
                    e.resolve({
                      range: r.range,
                      url: s.val(),
              ...
              .one("hidden.bs.modal", function () {
                a.off("input keypress"),
                  s.off("input keypress"),
                  l.off("click"),
        ...
        (this.show = function (e) {
          ...
          t.invoke("editor.saveRange", i),
            this.showLinkDialog(i, o, a)
              .then(function (e) {
                t.invoke("editor.restoreRange", i),
                  t.invoke("editor.createLink", i, e, s),
                  t.invoke("popover.hide", r);
              })
              .fail(function () {
                t.invoke("editor.restoreRange", i);
              });
    ...
    H = function (t) {
      ...
      (this.show = function (e) {
        var n = e.dialog(),
          o = e.editable();
        t.invoke("editor.saveRange", o),
          this.showImageDialog(o, n)
            .then(function (n) {
              t.invoke("editor.restoreRange", o),
                "string" == typeof n
                  ? t.invoke("editor.insertImage", o, n)
                  : t.insertImages(e, n);
            })
            .fail(function () {
              t.invoke("editor.restoreRange", o);
    ...
    B = function (t) {
      (this.showHelpDialog = function (t, n) {
        ...
        (this.show = function (e) {
          var n = e.dialog(),
            o = e.editable();
          t.invoke("editor.saveRange", o, !0),
            this.showHelpDialog(o, n).then(function () {
              t.invoke("editor.restoreRange", o);
            });
        });
    },
    z = function () {
      ...
      var o = (this.bindCustomEvent = function (e, t, n) {
        return function () {
          ...
          return (
            o && o.apply(e[0], arguments),
            e.trigger("summernote." + n, arguments)
          );
        };
      });
      this.insertImages = function (t, i) {
        var r = t.editor(),
          ...
          d = r.data("options");
        l.onImageUpload
          ? o(s, l, "image.upload")(i)
          : e.each(i, function (e, t) {
              var i = t.name;
              d.maximumImageFileSize && d.maximumImageFileSize < t.size
                ? o(
                    s,
                    l,
                    "image.upload.error"
                  )(d.langInfo.image.maximumFileSizeError)
                : g
                    .readFileAsDataURL(t)
                    .then(function (e) {
      ...
      this.updateStyleInfo = function (e, t) {
        if (e) {
          ...
          o || n.toolbar.update(t.toolbar(), e),
            n.popover.update(t.popover(), e, o),
            n.handle.update(t.handle(), e, o);
        }
      };
      var s = function (e) {
          var o = e.target;
        ...
        p = function (t) {
          ...
          if (o.length) {
            ...
            if (
              -1 !==
              e.inArray(a, ["resize", "floatMe", "removeMedia", "imageShape"])
            ) {
              var f = u.handle().find(".note-control-selection");
              r = e(f.data("target"));
            }
            if (
              (d && o.parents(".popover").hide(),
              e.isFunction(e.summernote.pluginEvents[a]))
            )
              e.summernote.pluginEvents[a](t, n.editor, u, l);
            else if (n.editor[a]) {
              var p = u.editable();
        ...
        y = function (t, n) {
          ...
          if (void 0 === t.offsetX) {
            ...
            o = { x: t.pageX - d.left, y: t.pageY - d.top };
          } else o = { x: t.offsetX, y: t.offsetY };
          var c = { c: Math.ceil(o.x / v) || 1, r: Math.ceil(o.y / v) || 1 };
          s.css({ width: c.c + "em", height: c.r + "em" }),
            a.attr("data-value", c.c + "x" + c.r),
            3 < c.c &&
              c.c < n.insertTableMaxSize.col &&
              l.css({ width: c.c + 1 + "em" }),
            3 < c.r &&
              c.r < n.insertTableMaxSize.row &&
              l.css({ height: c.r + 1 + "em" }),
            r.html(c.c + " x " + c.r);
        };
      (this.bindKeyMap = function (t, o) {
        ...
        a.on("keydown", function (s) {
          var l = [];
          s.metaKey && l.push("CMD"),
            s.ctrlKey && !s.altKey && l.push("CTRL"),
            s.shiftKey && l.push("SHIFT");
          ...
          if (f) {
            if (
              ((c = e.summernote.pluginEvents[u]),
              e.isFunction(c) && c(s, n.editor, t))
            )
              return !1;
            (c = e.summernote.pluginEvents[f]),
              e.isFunction(c)
                ? c(s, n.editor, t)
                : n.editor[f]
                ? (n.editor[f](a, r.data("options")), s.preventDefault())
                : i[f] && (i[f].call(this, t), s.preventDefault());
          } else m.isEdit(s.keyCode) && n.editor.afterCommand(a);
        });
      }),
        (this.attach = function (e, t) {
          t.shortcuts && this.bindKeyMap(e, t.keyMap[l.isMac ? "mac" : "pc"]),
            e.editable().on("mousedown", r),
            e.editable().on("keyup mouseup", a),
            e.editable().on("scroll", u),
            n.clipboard.attach(e, t),
            n.handle.attach(e, t),
            e.popover().on("click", p),
            e.popover().on("mousedown", f),
            n.dragAndDrop.attach(e, t),
            t.airMode ||
              (e.toolbar().on("click", p),
              e.toolbar().on("mousedown", f),
        ...
        (this.attachCustomEvent = function (t, n) {
          ...
          r.focus(o(i, a, "focus")),
            ...
            r.keydown(function (e) {
              e.keyCode === m.code.ENTER && o(i, a, "enter").call(this, e),
                o(i, a, "keydown").call(this, e);
            }),
            r.keyup(o(i, a, "keyup")),
            r.on("mousedown", o(i, a, "mousedown")),
            r.on("mouseup", o(i, a, "mouseup")),
            r.on("scroll", o(i, a, "scroll")),
            r.on("paste", o(i, a, "paste"));
          var s = l.isMSIE
          ...
          r.on(s, function () {
            ...
            n.airMode ||
              (t.toolbar().click(o(i, a, "toolbar.click")),
              t.popover().click(o(i, a, "popover.click"))),
            h.isTextarea(c.head(i)) &&
              i.closest("form").submit(function (e) {
                t.holder().val(t.holder().code()),
                  o(i, a, "submit").call(this, e, i.code());
              }),
            h.isTextarea(c.head(i)) &&
              n.textareaAutoSync &&
            ...
            o(i, a, "init")(t);
          for (var d = 0, u = e.summernote.plugins.length; u > d; d++)
            e.isFunction(e.summernote.plugins[d].init) &&
              e.summernote.plugins[d].init(t);
        }),
    ...
    U = function () {
      var t = function (e, t) {
        ...
        a = {
          ...
          fontname: function (e, n) {
            var o = [],
              i = n.fontNames.reduce(function (e, t) {
                return l.isFontInstalled(t) ||
                  c.contains(n.fontNamesIgnoreCheck, t)
                  ? (o.push(t),
                    e +
          ...
          color: function (e, n) {
            var o =
              ...
              s = t("", { title: e.color.more, dropdown: r(a) });
            return i + s;
          },
          bold: function (e, t) {
          ...
          var s = function () {
            ...
            l = function () {
              var e = t('<span class="note-fontsize-10">100%</span>', {
                ...
                g =
                  (r.disableResizeImage
                    ? ""
                    : '<div class="btn-group">' + e + a + s + "</div>") +
                  '<div class="btn-group">' +
                  l +
                  d +
                  c +
            ...
            d = function () {
              for (
                var t = e("<div />"), n = 0, s = r.airPopover.length;
                s > n;
                n++
              ) {
                for (
                  var l = r.airPopover[n],
                    d = e('<div class="note-' + l[0] + ' btn-group">'),
                    c = 0,
                    u = l[1].length;
                  u > c;
                  c++
        ...
        f = function (e, t) {
          ...
          return (
            ...
            o.join('</div><div class="note-shortcut-row row">') +
            "</div>"
          );
        },
        p = function (e) {
          var t = [
            { kbd: "⌘ + B", text: e.font.bold },
            { kbd: "⌘ + I", text: e.font.italic },
            { kbd: "⌘ + U", text: e.font.underline },
            { kbd: "⌘ + \\", text: e.font.clear },
          ];
          return f(e.shortcut.textFormatting, t);
        },
        v = function (e) {
          var t = [
            { kbd: "⌘ + Z", text: e.history.undo },
            { kbd: "⌘ + ⇧ + Z", text: e.history.redo },
            { kbd: "⌘ + ]", text: e.paragraph.indent },
            { kbd: "⌘ + [", text: e.paragraph.outdent },
            { kbd: "⌘ + ENTER", text: e.hr.insert },
          ];
          return f(e.shortcut.action, t);
        },
        g = function (e) {
          var t = [
            { kbd: "⌘ + ⇧ + L", text: e.paragraph.left },
            { kbd: "⌘ + ⇧ + E", text: e.paragraph.center },
            { kbd: "⌘ + ⇧ + R", text: e.paragraph.right },
            { kbd: "⌘ + ⇧ + J", text: e.paragraph.justify },
            { kbd: "⌘ + ⇧ + NUM7", text: e.lists.ordered },
            { kbd: "⌘ + ⇧ + NUM8", text: e.lists.unordered },
          ];
          return f(e.shortcut.paragraphFormatting, t);
        },
        m = function (e) {
          var t = [
            { kbd: "⌘ + NUM0", text: e.style.normal },
            { kbd: "⌘ + NUM1", text: e.style.h1 },
            { kbd: "⌘ + NUM2", text: e.style.h2 },
            { kbd: "⌘ + NUM3", text: e.style.h3 },
            { kbd: "⌘ + NUM4", text: e.style.h4 },
            { kbd: "⌘ + NUM5", text: e.style.h5 },
            { kbd: "⌘ + NUM6", text: e.style.h6 },
          ];
        ...
        b = function (e, t) {
          var n = t.extraKeys,
            o = [];
          for (var i in n)
            n.hasOwnProperty(i) && o.push({ kbd: i, text: n[i] });
        ...
        y = function (e, t) {
          ...
          return (
            t.extraKeys && o.push("<div " + n + ">" + b(e, t) + "</div>"),
        ...
        k = {
          image: function (e, t) {
            ...
            if (t.maximumImageFileSize) {
              var o = Math.floor(
                  Math.log(t.maximumImageFileSize) / Math.log(1024)
                ),
                r =
                  1 * (t.maximumImageFileSize / Math.pow(1024, o)).toFixed(2) +
                  " " +
                  " KMGTP"[o] +
                  "B";
          ...
          link: function (e, t) {
            var n =
                ...
                '</label><div class="fg-line"><input class="note-link-text form-control" type="text" /></div></div><div class="form-group row"><label>' +
                e.link.url +
                '</label><div class="fg-line"><input class="note-link-url form-control col-md-12" type="text" value="http://" /></div></div>' +
                (t.disableLinkTarget
                  ? ""
      ...
      (this.createLayoutByAirMode = function (t, n) {
        ...
        t.addClass("note-air-editor note-editable panel-body"),
          t.attr({ id: "note-editor-" + r, contentEditable: !0 });
        var a = document.body,
          c = e(s(o, n));
        c.addClass("note-air-layout"),
          c.attr("id", "note-popover-" + r),
          c.appendTo(a),
          T(c, i),
          S(c, n);
        var f = e(u(n));
        f.addClass("note-air-layout"),
          f.attr("id", "note-handle-" + r),
          f.appendTo(a);
        var h = e(x(o, n));
        h.addClass("note-air-layout"),
          h.attr("id", "note-dialog-" + r),
          h.find("button.close, a.modal-close").click(function () {
        ...
        (this.createLayoutByFrame = function (t, n) {
          ...
          n.height && c.height(n.height),
            n.direction && c.attr("dir", n.direction);
          var f = t.attr("placeholder") || n.placeholder;
          f && c.attr("data-placeholder", f),
            c.html(h.html(t) || h.emptyPara),
            e('<textarea class="note-codable"></textarea>').prependTo(r);
          ...
          for (
            ...
            for (
              var b = n.toolbar[g][0],
                y = n.toolbar[g][1],
                C = e('<div class="note-' + b + ' btn-group" />'),
                k = 0,
                N = y.length;
              N > k;
              k++
        ...
        (this.noteEditorFromHolder = function (t) {
          return t.hasClass("note-air-editor")
            ? t
            : t.next().hasClass("note-editor")
            ? t.next()
            : e();
        }),
        ...
        (this.removeLayout = function (e, t, n) {
          n.airMode
            ...
            : (e.html(t.editable().html()),
              n.dialogsInBody && t.dialog().remove(),
              t.editor().remove(),
              e.show());
        }),
        (this.getTemplate = function () {
          return { button: t, iconButton: n, dialog: i };
        }),
  ...
  e.extend(e.summernote, {
    renderer: O,
    eventHandler: j,
    core: { agent: l, list: c, dom: h, range: p },
    pluginEvents: {},
    plugins: [],
  }),
    ...
    e.fn.extend({
      summernote: function () {
        ...
        if (
          ...
          (i.icons = e.extend({}, e.summernote.options.icons, i.icons)),
          (i.langInfo = e.extend(
            !0,
            {},
          ...
          for (var r = 0, a = e.summernote.plugins.length; a > r; r++) {
            ...
            i.plugin[s.name] &&
              (e.summernote.plugins[r] = e.extend(!0, s, i.plugin[s.name]));
          }
      ...
      code: function (t) {
        if (void 0 === t) {
          ...
          if (i && i.length) {
            ...
            return (
              j.invoke("codeview.sync", o),
              r ? o.codable().val() : o.editable().html()
            );
          }
          return h.value(n);
        }
