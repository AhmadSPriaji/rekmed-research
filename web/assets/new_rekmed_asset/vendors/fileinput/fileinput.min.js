+(function (e) {
      ...
      if (
        ...
        (this.name = this.$input.attr("name") || i.name),
          ...
          0 === this.$hidden.length &&
            (this.$hidden = e('<input type="hidden">').insertBefore(
              this.$input
            )),
        ...
        "inline" !== this.$preview.css("display") &&
          "0px" !== n &&
          "none" !== n &&
          this.$preview.css("line-height", n),
          (this.original = {
  ...
  (i.prototype.listen = function () {
    this.$input.on("change.bs.fileinput", e.proxy(this.change, this)),
      ...
      this.$element
        ...
        .on("click.bs.fileinput", e.proxy(this.trigger, this)),
      this.$element
        .find('[data-dismiss="fileinput"]')
        .on("click.bs.fileinput", e.proxy(this.clear, this));
  }),
    (i.prototype.change = function (t) {
      var i =
        void 0 === t.target.files
          ? t.target && t.target.value
            ? [{ name: t.target.value.replace(/^.+\\/, "") }]
            : []
          : t.target.files;
      if ((t.stopPropagation(), 0 === i.length)) return void this.clear();
      this.$hidden.val(""),
      ...
      if (
        ...
        ("undefined" != typeof n.type
          ? n.type.match(/^image\/(gif|png|jpeg)$/)
        ...
        (s.onload = function (t) {
          var s = e("<img>");
          (s[0].src = t.target.result),
            (i[0].result = t.target.result),
            l.find(".fileinput-filename").text(n.name),
            "none" != a.css("max-height") &&
              s.css(
                "max-height",
                parseInt(a.css("max-height"), 10) -
                  parseInt(a.css("padding-top"), 10) -
                  parseInt(a.css("padding-bottom"), 10) -
                  parseInt(a.css("border-top"), 10) -
                  parseInt(a.css("border-bottom"), 10)
              ),
            a.html(s),
            l.addClass("fileinput-exists").removeClass("fileinput-new"),
            l.trigger("change.bs.fileinput", i);
        }),
          s.readAsDataURL(n);
      } else
        this.$element.find(".fileinput-filename").text(n.name),
  ...
  (e.fn.fileinput = function (t) {
    return this.each(function () {
      var n = e(this),
        s = n.data("bs.fileinput");
      s || n.data("bs.fileinput", (s = new i(this, t))),
        "string" == typeof t && s[t]();
    });
  }),
    (e.fn.fileinput.Constructor = i),
    (e.fn.fileinput.noConflict = function () {
